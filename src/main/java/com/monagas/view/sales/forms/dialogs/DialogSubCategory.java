...
public class DialogSubCategory extends JDialog {
    ...
    public DialogSubCategory(Frame parent, boolean modal, JTable table, Long id, boolean isRegister) {
        super(parent, modal);
        this.parent = parent;
        this.table = table;
        this.id = id;
